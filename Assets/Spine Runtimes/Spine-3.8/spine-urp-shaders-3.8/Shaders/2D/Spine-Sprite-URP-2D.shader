Shader "Universal Render Pipeline/2D/Spine 3.8/Sprite"
{
	Properties
	{
	...
	SubShader
	{
		...
		UsePass "Universal Render Pipeline/2D/Spine 3.8/Skeleton Lit/UNLIT"
	}

	FallBack "Universal Render Pipeline/2D/Spine 3.8/Skeleton Lit"
