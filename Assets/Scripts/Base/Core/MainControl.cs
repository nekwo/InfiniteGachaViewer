...
namespace NikkeViewerEX.Core
{
    ...
    public class MainControl : MonoBehaviour
    {
        ...
        [Header("Azur Lane Settings")]
        [Tooltip("Prefab for Azur Lane Live2D viewer")]
        [SerializeField]
        ...
        private void OnDestroy()
        {
            ...
            {
                // NonNativeKeyboard may already be destroyed
            }
        ...
        /// <summary>
        /// Instantiate an Azur Lane Live2D viewer.
        /// </summary>
        public AzurLaneViewer InstantiateAzurLaneViewer()
        {
            if (m_AzurLaneViewerPrefab == null)
            {
                Debug.LogError("[MainControl] AzurLane viewer prefab is not assigned.");
                return null;
            }
